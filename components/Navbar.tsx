...
export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 w-full bg-brand-white/80 backdrop-blur-md border-b border-brand-pink/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center">
            <Link 
              href="#booking"
              className="bg-brand-pink text-brand-navy px-5 py-2 text-sm rounded-full font-medium hover:bg-brand-pink/90 transition-colors shadow-sm"
            >
              Book Now
            </Link>
          </div>
